            ...
            <div className=' bg-gray-600 pt-16'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mx-5'>
                    ...
                    <div class="card bg-base-200 shadow-xl">
                        <div class="card-body">
                            <div className='flex items-center justify-center'><h2 class="text-center font-bold text-2xl mb-2">Total Product </h2>  <img className='w-8 ml-2' src={product} alt="" /></div>
                    ...
                    <div class="card bg-base-200 shadow-xl">
                        <div class="card-body">
                        <div className='flex items-center justify-center'><h2 class="text-center font-bold text-2xl mb-2">Happy Client </h2>  <img className='w-8 ml-2' src={client} alt="" /></div>
                    ...
                    <div class="card bg-base-200 shadow-xl">
                        <div class="card-body">
                        <div className='flex items-center justify-center'><h2 class="text-center font-bold text-2xl mb-2">Our Partner </h2>  <img className='w-8 ml-2' src={partner} alt="" /></div>
                    ...
                    <div class="card bg-base-200 shadow-xl">
                        <div class="card-body">
                        <div className='flex items-center justify-center'><h2 class="text-center font-bold text-2xl mb-2">Reviews </h2>  <img className='w-6 ml-2' src={review} alt="" /></div>
